<template>
    <div class="layout">
        ...
        <div class="line">
            <dj-input placeholder="Please Input" v-model="djInputClear" />
        </div>
        <div class="line">
            <dj-input placeholder="Please Input" v-model="djInputClear" disabled />
        </div>
        <div class="line">
            <dj-input placeholder="Please Input" v-model="djInputClear" clear />
        </div>
        <div class="line">
            <dj-input placeholder="Please Input" v-model="djInputClear">
