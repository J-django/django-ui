...
<template>
    <div class="layout">
        <div class="line">
            <dj-divider align="left" type="dashed" text="New Divider" :offset="10" />
        </div>
        <div class="line">
            <dj-segmented :data="switchArray" v-model="switchValue" disabled />
        </div>
        <div class="line">
        ...
        <div class="line">
            ...
            <dj-accordion v-model="accordion" :disabled="accordionDisabled" title="发现更美好的自己，追寻内心的光芒"
